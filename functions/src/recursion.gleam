...
pub fn main() {
  let nums = [1, 2, 3, 4, 5]
  io.println("length nums = " <> string.inspect(length(nums)))
  io.println("length [] = " <> string.inspect(length([])))

  io.println("factorial(5) = " <> string.inspect(factorial(5)))
  io.println("factorial(0) = " <> string.inspect(factorial(0)))
